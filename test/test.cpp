...
*/
    ...
    std::cout << MetaAD::calcPartialDerivative(&addNodeTest6, &matrixNode1).getValue() <<std::endl;
    
    std::cout << "Test kronecker product " << std::endl;
    Eigen::MatrixXd kroneckerTest1 = Eigen::MatrixXd::Ones(3,2);
    kroneckerTest1 << 1, 2, 3, 4, 5, 6;
    Eigen::MatrixXd kroneckerTest2 = Eigen::MatrixXd::Ones(2,3);
    kroneckerTest2 << 1, 2, 3, 4, 5, 6;
    std::cout << kroneckerTest2 <<std::endl;
    Eigen::MatrixXd kroneckerResult = Eigen::kroneckerProduct(kroneckerTest1, kroneckerTest2);
    std::cout << kroneckerResult << std::endl;

    std::cout << "Test Mul.hpp" << std::endl;
    std::cout << MetaAD::ad_math::mul_derivative_policy<double ,double>::derivative<1>(3,4,12) << std::endl;
    std::cout << MetaAD::ad_math::mul_derivative_policy<MetaAD::ad_MatrixXd ,MetaAD::ad_MatrixXd>::derivative<0>(kroneckerTest1,kroneckerTest2,kroneckerTest1*kroneckerTest2) << std::endl;
    std::cout << std::endl;
    DOUBLE<13> mulTest1 = 5;
    DOUBLE<14> mulTest2 = 6;
    
    std::cout << "Test MulNode.hpp" << std::endl;
    MATRIXXD<15> matrixNode5(kroneckerTest1);
    MATRIXXD<16> matrixNode6(kroneckerTest2);
    auto mulNodeTest1 = MetaAD::mul<17>(matrixNode6, matrixNode5);
    std::cout << mulNodeTest1.getValue() << std::endl;
    std::cout << std::endl;
    auto mulNodeTest2 = MetaAD::mul<18>(addNodeTest6, mulNodeTest1);
    std::cout << mulNodeTest2.getValue() << std::endl;
    std::cout << std::endl;
    std::cout << MetaAD::calcPartialDerivative(&mulNodeTest2, &matrixNode5).getValue() <<std::endl;
