...
#ifndef METAAUTODIFF_ARRAYDIV_HPP
#define METAAUTODIFF_ARRAYDIV_HPP

#include"ArrayDivTrait.hpp"
...
struct array_div_policy;

template<>
struct array_div_policy<ad_MatrixXd, ad_MatrixXd> {
    using OutputValueType = typename array_div_trait<ad_MatrixXd, ad_MatrixXd>::type;
